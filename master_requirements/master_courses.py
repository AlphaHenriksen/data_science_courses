...
def ects_requirements(current_courses, general_1, general_2, techno):
    ...
    print(f"The total number of ECTS points in the plan is {
        (current_courses.points) - 10}\
            n")  # Subtract 10 from total since these points are from the bachelor
...
def alternative_courses(core, courselist):
